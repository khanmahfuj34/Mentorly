      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-on-surface-variant font-body-md">
            Review active learning schedules, tutor assignments, and bookings.
          </p>
        </div>
        <button
      ...
      <div className="space-y-4">
        {isLoading ? (
          ...
          <EmptyApplicationState
            ...
            subtitle="Your active bookings will appear here once you accept a tutor application for your tuition requests."
            icon="event_note"
