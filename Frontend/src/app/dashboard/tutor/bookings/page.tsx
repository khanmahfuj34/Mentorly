  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-10 md:px-10 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-on-surface-variant font-body-md leading-relaxed">
            View your active teaching contracts and scheduled tuition sessions.
          </p>
        </div>
        <button
      ...
      {!isLoading && bookings.length > 0 && (
        ...
        >
          {[
            { label: "Total Bookings", value: bookings.length, icon: "event_available", color: "text-on-surface" },
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <div className="w-20 h-20 rounded-full bg-primary/8 border border-primary/15 flex items-center justify-center mb-5">
              <span className="material-symbols-outlined text-4xl text-primary select-none">event_available</span>
            </div>
            ...
            <p className="text-on-surface-variant font-body-md max-w-sm mb-8 leading-relaxed">
              Once a student accepts your application, the booking will appear here automatically.
            </p>
            <Link
